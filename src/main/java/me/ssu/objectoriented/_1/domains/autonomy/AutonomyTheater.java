...
public class AutonomyTheater {
	...
	// TODO 2-1) 의존성이 높은 소극장의 입구 메소드 -> 판매원에게 역할로 주기
	...
	//	}
	// TODO 2-2) 캡슐화한 관람객으로 인해 메소드 파라미터 수정
	public void enter(EncapsulationAudience encapsulationAudience) {
		autonomyTicketSeller.sellToEncapsulationAudience(encapsulationAudience);
	}
}